...
COPY access_control.py app_context.py bot.py config.py diagnostics.py download_station.py state_store.py storage.py subscription_policy.py series_bulk_planner.py series_continue.py voice_transcription.py gpt_client.py gpt_features.py rutracker.py kinopoisk.py jackett.py jackett_subscriptions.py movie_discovery.py formatters.py keyboards.py plex.py progressive_status.py task_policies.py task_views.py torrent_utils.py tracker_service.py ./
COPY assets/ ./assets/
