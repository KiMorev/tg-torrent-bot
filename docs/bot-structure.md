...
| `movie_discovery_settings.json` | Настройки `/new`, подписчики, per-user seen/shown/handled flags, Jackett trackers, snapshot последних push-уведомлений `/new`. |
