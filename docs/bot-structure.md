...
| Нормализация имён файлов сериалов | `bot.py`: `normalize_command`, `_normalization_entry_screen`, `_inspect_completed_task_normalization`, `_handle_normalization_callback`; `filename_normalizer.py`; `storage.py` | `tests/test_filename_normalizer.py`, `tests/test_background.py`, `tests/test_handlers.py`, `tests/test_keyboards.py` |
