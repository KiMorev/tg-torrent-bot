...
| `series_continue_totals.json` | Кэш количества эпизодов сезона и карты сезонов из TMDB/TVmaze для `/seasons`, keyed by Plex/external id. |
