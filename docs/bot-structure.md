...
| `cont:*` | `bot.py` | `series_continue_callback`: список `/seasons`, переключение `Моё` / `Всё` / скрытые, refresh, карточка сезона, `cont:hide:*`, `cont:unhide:*`, `cont:update_topic:*`, `cont:subscribe_topic:*`, `cont:search_alt:*`, `cont:alt_dl:*`; missing-list: `cont:list:missing:*`, `cont:missing_refresh`, `cont:missing_open:*`, `cont:missing_hide:*`, `cont:missing_unhide:*`, `cont:missing_bulk:*`. |
