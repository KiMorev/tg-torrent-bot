...
Если похожая раздача в `/seasons` не содержит серий новее Plex/истории, бот не отправляет её в Download Station. Для неполной раздачи он сохраняет подписку на выбранную тему и ждёт следующих серий.
