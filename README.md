...
- умеет присылать push о новых подходящих фильмах подписчикам `/new`: до трёх карточек, ссылка на Кинопоиск в названии при наличии URL, постер главной новинки при наличии постера и обычный текстовый fallback при ошибке;
