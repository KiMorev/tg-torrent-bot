...
def search_stages() -> list[tuple[float, str]]:
    ...
    return [
        (
            10.0,
            "🔎 Всё ещё ищу\n\n"
            "Некоторые трекеры отвечают медленно. Дождитесь результата, повторно нажимать не нужно.",
        ),
        (
            25.0,
            "⌛ Поиск занимает дольше обычного\n\n"
            "Продолжаю ждать ответ от трекеров. Если источники не ответят, покажу понятную ошибку.",
        ),
    ]
