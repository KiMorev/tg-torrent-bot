...
def did_you_mean(
    *,
    ...
    system_prompt = (
        ...
        "  4. Description recognition: if the query reads like a description "
        ...
        "major productions, recognisable franchises. The bot will additionally "
        "verify each suggestion against Kinopoisk before showing it to the "
        "user, but you should NOT invent plausible-sounding fake titles to "
        "fill the array. Empty array is always better than a hallucinated film.\n"
        "\n"
        ...
        "             → [\"Шрек\", \"Shrek\"]\n"
        "  «Гангстерленд» → []  (real 2018 Russian film — don't invent fixes)\n"
